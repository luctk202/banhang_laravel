...
-->
    ...
    <!-- jQuery -->
    <script src="{{asset('client/assets/js/jquery-2.1.0.min.js')}}"></script>
    ...
    <script src="{{asset('client/assets/js/datepicker.js')}}"></script>
    <script src="{{asset('client/assets/js/scrollreveal.min.js')}}"></script>
    ...
    <script src="{{asset('client/assets/js/imgfix.min.js')}}"></script>
